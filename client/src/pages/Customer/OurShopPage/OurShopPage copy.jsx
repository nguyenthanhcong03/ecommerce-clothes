...
import { FilterSidebar } from '@/pages/customer/OurShopPage/components/FilterSidebar copy';
      ...
      <div className='flex w-full flex-col gap-6 lg:flex-row'>
        ...
        <div className='lg:w-3/4'>
          ...
          <h1 className='mb-4 rounded-md bg-white p-4 text-2xl font-bold'>
            {filters.search ? 'Kết quả tìm kiếm' : currentCategory?.name || 'Tất cả sản phẩm'}
          </h1>
          {!filters.search && (
