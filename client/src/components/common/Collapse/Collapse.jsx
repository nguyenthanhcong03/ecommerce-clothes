...
function Collapse({ children, title, className = '', isShow = false, isFooter = false }) {
  ...
  return (
    <div className='w-full'>
      <button
        ...
        className={`flex w-full items-center justify-between px-4 py-2 text-left text-white ${className}`}
      >
