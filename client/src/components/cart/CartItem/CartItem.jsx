...
function CartItem({ item }) {
  ...
  const handleItemClick = useCallback(() => {
    navigate(`/product/${item.snapshot._id}`);
  }, [item, navigate]);
  ...
  return (
    <div className='group relative flex items-center justify-between gap-2 overflow-hidden p-4 transition-colors duration-200 ease-in hover:bg-[#f7f7f7]'>
