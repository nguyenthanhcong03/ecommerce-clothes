  ...
  return (
    <div className='w-full bg-[#F1F1F1] text-primaryColor p-5'>
      <div className='container mx-auto flex max-w-[1280px] flex-col md:grid md:grid-cols-4 md:justify-items-center'>
        ...
        <Collapse title={'HỆ THỐNG CỬA HÀNG'}>
          <div className='flex flex-col gap-2 px-5 pb-3'>
            <p>
              Hà Nội:
              <br />
        ...
        <Collapse title={'KẾT NỐI'} isShow={true}>
