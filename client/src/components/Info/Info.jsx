...
function Info() {
  return (
    <div className='w-full'>
      <div className='relative mx-auto mt-[-90px] grid max-w-[1280px] items-center justify-items-center bg-primaryColor py-5 container md:grid-cols-2 xl:grid-cols-4'>
