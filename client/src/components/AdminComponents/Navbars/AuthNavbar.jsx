...
import PagesDropdown from '@components/AdminComponents/Dropdowns/PagesDropdown.jsx';
          ...
          >
            <ul className='mr-auto flex list-none flex-col lg:flex-row'>
              <li className='flex items-center'>
                ...
                >
                  <i className='lg:text-blueGray-200 text-blueGray-400 far fa-file-alt leading-lg mr-2 text-lg' /> Docs
                </a>
              </li>
            </ul>
